...
| sales_amount    | DECIMAL       | The total monetary value of the sale for the line item, in whole currency units (e.g., 25, 30.50).|
| quantity        | INT           | The number of units of the product ordered for the line item (e.g., 1).                       |
| price           | DECIMAL       | The price per unit of the product for the line item, in whole currency units (e.g., 25, 30.50).|
